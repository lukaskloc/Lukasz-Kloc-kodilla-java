...
public class TaskListDaoTestSuite {
    ...
    private static final String TASKLISTNAME = "Task List Name";
    private static final String TASKLISTDESCRIPTION = "Task List Description";
    ...
    public void testTaskListDaoSaveWithTasks() {
        //Given
        Task task = new Task("Test: Learn to hibernate", 14);
